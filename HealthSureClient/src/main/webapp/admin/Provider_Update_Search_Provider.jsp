    ...
    <f:view>
        <div class="container">
            ...
            <h:form>
                ...
                <h:inputText id="providerId" value="#{doctorController.provider.providerId}" required="true">
                    <f:attribute name="placeholder" value="Enter Provider ID" />
                </h:inputText>
				
                <!-- Search Button -->
                <h:commandButton value="Get Provider Details" action="#{doctorController.showProviderDetails}" styleClass="search-btn">
                    <!-- Pass providerId as a parameter to the next page -->
                    <f:param name="doctorId" value="#{doctorController.provider.providerId}" />
                </h:commandButton>
