...
<head>
    ...
    <style>
        ...
        .menu-button {
            ...
            background: linear-gradient(135deg, #00796b, #004d40); /* Gradient effect */
            color: white;
            padding: 15px 25px;
            text-align: center;
        ...
        .menu-button:hover {
            background: linear-gradient(135deg, #004d40, #00796b); /* Reverse gradient for hover */
        ...
        .menu-button:active {
            ...
            box-shadow: 0 2px 5px rgba(0, 0, 0, 0.2); /* Light shadow when clicked */
        }
